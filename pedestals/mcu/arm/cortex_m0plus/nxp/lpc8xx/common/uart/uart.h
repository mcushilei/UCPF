...
#ifndef __DRIVER_ARM_M0PLUS_NXP_LPC8XX_UART_H__
#define __DRIVER_ARM_M0PLUS_NXP_LPC8XX_UART_H__
...
//! \brief interface of UART
//! @{
typedef struct {
    bool        (*Init)(const uart_cfg_t *pCFG);
    bool        (*DeInit)(void);
...
#endif  // #ifndef __DRIVER_ARM_M0PLUS_NXP_LPC8XX_UART_H__
