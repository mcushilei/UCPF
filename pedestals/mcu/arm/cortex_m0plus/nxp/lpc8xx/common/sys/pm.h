...
#ifndef __DRIVER_ARM_M0PLUS_NXP_LPC8XX_PM_H__
#define __DRIVER_ARM_M0PLUS_NXP_LPC8XX_PM_H__
...
#define SPI0_RST    BIT(0)
#define SPI1_RST    BIT(1)
#define UARTFRG_RST BIT(2)
#define UART0_RST   BIT(3)
#define UART1_RST   BIT(4)
#define UART2_RST   BIT(5)
#define I2C0_RST    BIT(6)
#define MRT_RST     BIT(7)
#define SCT_RST     BIT(8)
#define WKT_RST     BIT(9)
#define GPIO_RST    BIT(10)
#define FLASH_RST   BIT(11)
#define ACMP_RST    BIT(12)
#define I2C1_RST    BIT(14)
#define I2C2_RST    BIT(15)
#define I2C3_RST    BIT(16)
#define ADC_RST     BIT(24)
#define DMA_RST     BIT(29)
...
extern void     sysctrl_periph_reset(uint32_t mask);
...
#endif  // #ifndef __DRIVER_ARM_M0PLUS_NXP_LPC8XX_PM_H__
