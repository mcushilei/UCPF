...
#ifndef __DRIVER_ARM_M3_NXP_LPC1768_DEVICE_H__
#define __DRIVER_ARM_M3_NXP_LPC1768_DEVICE_H__

/*============================ INCLUDES ======================================*/
#include ".\app_cfg.h"

/* These are used by CMSIS. */
typedef enum {
...
#define GPIO0_BASE_ADDRESS              (0x2009C000u)
#define GPIO1_BASE_ADDRESS              (0x2009C020u)
#define GPIO2_BASE_ADDRESS              (0x2009C040u)
#define GPIO3_BASE_ADDRESS              (0x2009C060u)
#define GPIO4_BASE_ADDRESS              (0x2009C080u)
...
#define EMAC_BASE_ADDRESS               (0x50000000u)
