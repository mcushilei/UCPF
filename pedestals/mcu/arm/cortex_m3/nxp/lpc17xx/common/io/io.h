...
/*============================ MACROS ========================================*/
/*============================ MACROFIED FUNCTIONS ===========================*/
#define __GPIO_INTERFACE(__N, __VALUE)      const i_gpio_t PORT##__N;
...
#define PIN_CFG(...)                                                 \
    do {                                                            \
        ...
        PIN.Config(tCFG, ARRAY_LENGTH(tCFG));                        \
    } while(0)

#define DRIVER_PIN_FUNC(__F)        (__F)
        
#define DRIVER_PIN_MODE_PULL_UP         (0)
#define DRIVER_PIN_MODE_PULL_REPEATER   (1)
#define DRIVER_PIN_MODE_PULL_NONE       (2)
#define DRIVER_PIN_MODE_PULL_DOWN       (3)
        
#define DRIVER_PIN_MODE_OPEN_DRAIN      (1u << 2)
...
DEF_INTERFACE(i_io_t)
    union {
        const i_gpio_t PORT[GPIO_COUNT];
        struct {
