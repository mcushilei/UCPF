...
DEF_STRUCTURE(__i2c_t)
    i2c_reg_t *const            ptREG;         //!< reference to register page
...
static bool i2c_master_init(__i2c_t *ptThis, uint32_t wClockRate)
{
    ...
    SAFE_CLK_CODE(
        ...
        this.ptREG->SCLH.SCLH = wTempHigh;
        this.ptREG->SCLL.SCLL = wTempLow;
        this.ptREG->CONCLR.Value = I2C_CONCLR_STAC_MSK |
                                   I2C_CONCLR_AAC_MSK  |    //!< slave is not enabled.
                                   I2C_CONCLR_SIC_MSK;
        this.ptREG->CONSET.Value = I2C_CONSET_I2EN_MSK | I2C_CONSET_AA_MSK;
    )
...
{
    SAFE_CLK_CODE(
        uint32_t wTempADR = this.ptREG->ADR0.Value;

        wTempADR &= ~I2C_ADR_ADDRESS_MSK;
        wTempADR |= chAddress << I2C_ADR_ADDRESS0; //!< 7 bits address
        
        this.ptREG->ADR0.Value = wTempADR;
        this.ptREG->CONCLR.Value = I2C_CONCLR_STAC_MSK | I2C_CONCLR_SIC_MSK;
        this.ptREG->CONSET.Value = I2C_CONSET_I2EN_MSK | I2C_CONSET_AA_MSK;
    )
...
static bool i2c_slave_set_address(__i2c_t *ptThis, i2c_addr_cfg_t *ptAddrCfg)
{
    ...
    switch (ptAddrCfg->chAddrIndex) {
        case 0:
            wTempADR    = this.ptREG->ADR0.Value;
            wTempMASK   = this.ptREG->MASK0.Value;
            break;
        case 1:
            wTempADR    = this.ptREG->ADR1.Value;
            wTempMASK   = this.ptREG->MASK1.Value;
            break;
        case 2:
            wTempADR    = this.ptREG->ADR2.Value;
            wTempMASK   = this.ptREG->MASK2.Value;
            break;
        case 3:
            wTempADR    = this.ptREG->ADR3.Value;
            wTempMASK   = this.ptREG->MASK3.Value;
            break;
        default:
            break;
    }
    ...
    switch (ptAddrCfg->chAddrIndex == 0) {
        case 0:
            this.ptREG->ADR0.Value  = wTempADR;
            this.ptREG->MASK0.Value = wTempMASK;
            break;
        case 1:
            this.ptREG->ADR1.Value  = wTempADR;
            this.ptREG->MASK1.Value = wTempMASK;
            break;
        case 2:
            this.ptREG->ADR2.Value  = wTempADR;
            this.ptREG->MASK2.Value = wTempMASK;
            break;
        case 3:
            this.ptREG->ADR3.Value  = wTempADR;
            this.ptREG->MASK3.Value = wTempMASK;
            break;
        default:
            return false;
    }
...
static bool i2c_slave_get_address(__i2c_t *ptThis, i2c_addr_cfg_t *ptAddrCfg)
{
    ...
    switch (ptAddrCfg->chAddrIndex) {
        ...
        default:
            wTempADR = this.ptREG->ADR0.Value;
            wTempMSK = this.ptREG->MASK0.Value;
            break;
        case 1:
            wTempADR = this.ptREG->ADR1.Value;
            wTempMSK = this.ptREG->MASK1.Value;
            break;
        case 2:
            wTempADR = this.ptREG->ADR2.Value;
            wTempMSK = this.ptREG->MASK2.Value;
            break;
        case 3:
            wTempADR = this.ptREG->ADR3.Value;
            wTempMSK = this.ptREG->MASK3.Value;
            break;
    }
...
{
    this.ptREG->CONSET.Value = I2C_CONSET_AA_MSK;
...
{
    this.ptREG->CONCLR.Value = I2C_CONCLR_AAC_MSK;
...
{
    this.ptREG->CONCLR.Value = I2C_CONCLR_SIC_MSK;
    this.ptREG->CONSET.Value = I2C_CONSET_STA_MSK;
}

static void i2c_bus_send_start_after_stop(__i2c_t *ptThis)
{
    this.ptREG->CONSET.Value = I2C_CONSET_STA_MSK | I2C_CONSET_STO_MSK;
    this.ptREG->CONCLR.Value = I2C_CONCLR_SIC_MSK;
}

static void i2c_bus_send_stop(__i2c_t *ptThis)
{
    this.ptREG->CONSET.Value = I2C_CONSET_STO_MSK;
    this.ptREG->CONCLR.Value = I2C_CONCLR_SIC_MSK;
}

static void i2c_bus_feed_data(__i2c_t *ptThis, uint8_t chData)
{
    this.ptREG->DAT.Value = chData;
    this.ptREG->CONCLR.Value = I2C_CONCLR_SIC_MSK;
}

static uint8_t i2c_bus_get_data(__i2c_t *ptThis)
{
    uint8_t chData = this.ptREG->DAT.Value;
    return chData;
}
...
{
    uint32_t wStatus = this.ptREG->STAT.Value;
...
//            if (this.ptREG->CONSET.Value & I2C_CONSET_SI_MSK) {
