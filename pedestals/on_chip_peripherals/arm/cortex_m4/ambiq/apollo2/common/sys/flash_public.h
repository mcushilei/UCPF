...
#ifndef __DRIVER_ARM_M4_AMBIQ_APOLLO2_FLASH_PUBLIC_H__
#define __DRIVER_ARM_M4_AMBIQ_APOLLO2_FLASH_PUBLIC_H__
...
#endif  //!< #ifndef __DRIVER_ARM_M4_AMBIQ_APOLLO2_FLASH_PUBLIC_H__
/* EOF */
