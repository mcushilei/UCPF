...
typedef struct {
    ...
    int32_t  (*bind)    (int32_t id, const char *host, const char *port, int32_t proto);
	int32_t  (*connect) (int32_t id, const char *host, const char *port, int32_t proto);
...
extern int  socket_api_bind(socket_t *pSocket, const char *host, const char *port);
